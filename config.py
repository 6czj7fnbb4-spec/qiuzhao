"""
秋招日报 - 配置
所有岗位均确认为 2027届 秋招/校招
链接来自 ncss.cn，无需登录直达岗位详情页
"""
import os
    ...
    "mid": {
        ...
        "jobs": [
            ...
            },
            {
                ...
                "location": "北京",
                "type": "2027届 · 暑期实习（有转正机会）",
                "why": "含直播+短视频+电商运营多方向，自媒体经验加分",
...
QUICK_SEARCHES = [
    ...
    {"label": "Boss直聘 · 新媒体应届", "url": "https://www.zhipin.com/web/geek/job?query=新媒体运营%20内容运营&experience=401&degree=203"},
    {"label": "国家就业平台 · 校招专区", "url": "https://www.ncss.cn/student/jobs/index.html"},
]

KEY_DATES = [
    {"date": "8月中旬", "event": "大厂秋招正式批大规模启动，岗位将大幅增加"},
